...
const { updateScores, getPositions, getPositionsAcumulated } = require('../controllers/ScoresControllers'); // ✅ un solo import
...
router.get('/positions-acumulated', getPositionsAcumulated); // ✅ sin token
